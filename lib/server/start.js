module.exports = {
    ...
    start: function(manifest) {
        ...
        if (global.MODE != "prod") var launcher = require('launch-browser');
        if (global.MODE != "prod") console.log('\t' + emojic.whiteCheckMark + '  Starting server');
        ...
        if (global.MODE != "prod") console.log('');
        ...
        function doStart() {
            ...
            if (global.MODE == "prod") app.IO = require('socket.io')(http);
            else app.IO = require('socket.io').listen(http);
