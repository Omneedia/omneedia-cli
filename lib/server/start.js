module.exports = {
    ...
    display_index: function(req, res) {
        ...
        reader(list, 0, function() {
            ...
            //<meta http-equiv="Content-Security-Policy" content="default-src * data:; img-src \'self\' data:; style-src \'self\' \'unsafe-inline\'; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\'">
            if (manifest.platform == "mobile")
                tpl.html = tpl.html.split('</head>')[0] + '<script type="text/javascript" src="/cordova.js"></script><link rel="icon" href="/favicon.ico" type="image/x-icon"/><link rel="shortcut" href="/favicon.ico" type="image/x-icon"/><style>' + _style + "</style>" + tpl.boot + "</head>" + tpl.html.split('</head>')[1];
            else
